...
const Manager = () => {
        ...
        if (form.site.length > 3 && form.username.length > 3 && form.password.length > 3) {
            try {
                if (form._id) {
                    ...
                    if (response.ok) {
                        // Update the password array with the edited password
                    ...
                    if (savedPassword?.result?.insertedId) {
                        setPasswordArray([...passwordArray, { ...form, _id: savedPassword.result.insertedId }]);
    ...
    const editPassword = (id) => {
        ...
        if (!passwordToEdit) {
            toast('Password not Found for Editing!', {
                position: "top-right",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
        ...
        // Populate the form with the password details
        setForm({
            site: passwordToEdit.site,
            username: passwordToEdit.username,
            password: passwordToEdit.password,
            _id: passwordToEdit._id
        });
